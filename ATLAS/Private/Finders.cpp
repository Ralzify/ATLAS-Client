...
uint64 FindSpecialEventPhaseActivate()
{
    auto sRef = Memcury::Scanner::FindStringRef(
        L"[ASpecialEventPhase::ActivatePhase()] Activating Phase Tag [%s] SequenceTimeOffset [%f]", false, 0, VersionInfo.FortniteVersion >= 17, false);
